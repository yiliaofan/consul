...
func AddFlags(fs *flag.FlagSet, f *Flags) {
	...
	add(&f.Config.HTTPConfig.WriteAllowedNets, "write-allowed-nets", "Only allow write endpoint calls from given network. CIDR format, can be specified multiple times.")
