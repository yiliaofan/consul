...
func TestFullConfig(t *testing.T) {
	...
	src := map[string]string{
		"json": `{
			...
			"http_config": {
				...
				"write_allowed_net": [ "127.0.0.1/8", "22.33.44.55/32", "0.0.0.0/0" ],
				"response_headers": {
					"M6TKa9NP": "xjuxjOzQ",
					"JRCrHZed": "rl0mTx81"
				}
	...
	want := RuntimeConfig{
		...
		//[ "127.0.0.1/8", "22.33.44.55/32", "0.0.0.0/0" ]
		WriteAllowedNets:        []*net.IPNet{cidr("127.0.0.0/8"), cidr("22.33.44.55/32"), cidr("0.0.0.0/0")},
		HTTPPort:                7999,
