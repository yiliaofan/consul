...
func init() {
	...
	registerEndpoint("/v1/agent/health/service/id/", []string{"GET", "HEAD"}, (*HTTPServer).AgentHealthServiceId)
	registerEndpoint("/v1/agent/health/service/name/", []string{"GET", "HEAD"}, (*HTTPServer).AgentHealthServiceName)
