...
func init() {
	...
	registerEndpoint("/v1/agent/health/service/id/", (*HTTPServer).AgentHealthServiceId)
	registerEndpoint("/v1/agent/health/service/name/", (*HTTPServer).AgentHealthServiceName)
